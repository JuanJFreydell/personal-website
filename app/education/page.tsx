const education = [
    ...
    },
    {
        ...
        short_description: "Graduated with perfect GPA, specializing in IT management and business analytics.",
  ...
  return (
    ...
    className="flex flex-col h-fit w-full justify-center items-center space-between bg-white mx-auto my-auto pt-8 text-black p-40">
        <div className="w-2/3 h-fit flex flex-col items-center justify-center gap-24 mt-20"> 
            {education.map((edu) => (
                <div key={edu.degree} className="flex flex-row w-full gap-8">
                    <div className="w-1/4">
                        <h3 className="text-md font-bold">{edu.degree}</h3>
                        <p className="text-sm font-light mt-1">{edu.institution}</p>
                    ...
                    <div className="flex flex-col gap-2 w-3/4">
                        <p className="text-lg font-light">{edu.short_description}</p>
                        <p className="text-sm">{edu.long_description}</p>
            ...
            <div className="w-full mt-8 pt-8 border-t border-gray-300">
                <h3 className="text-lg font-bold mb-4">Professional Certifications</h3>
